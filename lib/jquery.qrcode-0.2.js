...
(function ($) {
	...
	var createQr = function (typeNumber, correctLevel, text) {
		...
		createCanvas = function (settings) {
			...
			canvasElement.width = settings.width * dpr;
			canvasElement.height = settings.height * dpr;
			canvasElement.style.width = `${settings.width}px`;
			canvasElement.style.height = `${settings.height}px`;
